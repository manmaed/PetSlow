        ...
        if (entity instanceof EntityPetSlow) {
            ...
            if (petSlow.isSitting()) {
                if (petSlow.getAway()) {
                    ...
                    GlStateManager.translatef(this.headhat.pitch, this.headhat.yaw, this.headhat.roll);
                    ...
                    //Body
                    GlStateManager.pushMatrix();
                    GlStateManager.translatef(this.body.pitch, this.body.yaw, this.body.roll);
                    ...
                    //Head
                    GlStateManager.pushMatrix();
                    GlStateManager.translatef(this.head.pitch, this.head.yaw, this.head.roll);
                    ...
                    //Arm2
                    GlStateManager.pushMatrix();
                    GlStateManager.translatef(this.arm2.pitch, this.arm2.yaw, this.arm2.roll);
                    ...
                    //Arm1
                    GlStateManager.pushMatrix();
                    GlStateManager.translatef(this.arm1.pitch, this.arm1.yaw, this.arm1.roll);
                    ...
                    //Leg1
                    GlStateManager.pushMatrix();
                    GlStateManager.translatef(this.leg1sit.pitch, this.leg1sit.yaw, this.leg1sit.roll);
                    ...
                    //Leg2
                    GlStateManager.pushMatrix();
                    GlStateManager.translatef(this.leg2ssit.pitch, this.leg2ssit.yaw, this.leg2ssit.roll);
                ...
                //Leg1
                GlStateManager.pushMatrix();
                GlStateManager.translatef(this.leg1.pitch, this.leg1.yaw, this.leg1.roll);
                ...
                //Leg 2
                GlStateManager.pushMatrix();
                GlStateManager.translatef(this.leg2.pitch, this.leg2.yaw, this.leg2.roll);
