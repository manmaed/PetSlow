...
public class ModelChair<T extends Entity> extends EntityModel<T> {
    public Cuboid chairbase;
    public Cuboid chairback;
    public Cuboid leg1;
    public Cuboid leg2;
    public Cuboid leg3;
    public Cuboid leg4;
